...
Assert-Contains $control 'public const int MinBarCount = 8' 'EtherSlider even tick floor is 8'
Assert-Contains $control 'public const int MaxBarCount = 512' 'EtherSlider even tick ceiling is 512'

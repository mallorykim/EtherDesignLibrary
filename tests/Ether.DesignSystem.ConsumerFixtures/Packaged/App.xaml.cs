...
public partial class App : Application
{
    ...
    private static void VerifyPackageResources()
    {
        if (!Current.Resources.TryGetValue("Spacing8", out _) ||
            !Current.Resources.TryGetValue("EtherButtonPrimary", out _))
        {
            throw new InvalidOperationException(
                "The Ether DesignSystem.xaml package merge did not load its Foundation resource and Ether control style.");
        }
    }
}
